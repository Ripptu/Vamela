...
export const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  ...
  return (
    <footer className="bg-[#050505] relative pt-20 pb-10 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 border-t border-white/10 pt-20">
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-24">
            ...
            <div>
                ...
                <div className="flex flex-col md:flex-row gap-6 mt-12">
                     <a 
                        ...
                        className="group flex items-center gap-4 text-xl md:text-2xl text-white font-medium hover:text-orange-500 transition-colors"
                     >
                        <div className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center group-hover:bg-orange-500 group-hover:border-orange-500 group-hover:text-black transition-all">
            ...
            <div className="flex flex-col md:flex-row gap-12 lg:justify-end items-start pt-4">
                <div className="space-y-6">
                    <h4 className="text-xs font-mono text-gray-500 uppercase tracking-widest">Menu</h4>
                ...
                <div className="space-y-6">
                 ...
                 <div className="space-y-6">
                    <h4 className="text-xs font-mono text-gray-500 uppercase tracking-widest">Rechtliches</h4>
                    <ul className="space-y-3 text-lg font-medium text-gray-300">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 border-t border-white/5 pt-8">
            <div className="flex items-center gap-2">
                 ...
                 <span className="text-xs text-gray-500 uppercase tracking-wider font-mono">Systems Operational</span>
            </div>
            ...
            <button 
                onClick={scrollToTop} 
                className="group flex items-center gap-2 text-xs font-bold text-white uppercase tracking-widest hover:text-orange-500 transition-colors"
            >
                Back to Top 
